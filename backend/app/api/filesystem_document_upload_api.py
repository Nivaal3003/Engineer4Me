...
The router is not included in ``app.main`` by this module. Application
composition can include it after its focused contract tests are installed.
"""
...
@router.post(
    ...
    responses={
        _HTTP_CONTENT_TOO_LARGE: {
            "description": "One or more uploaded documents exceed limits.",
        },
